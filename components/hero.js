      ...
      <div className="lg:hidden relative">
        ...
        <div className="px-6 py-10">
          ...
          <p className="mt-6 text-sm font-medium text-pretty text-gray-500 font-display">
            ...
            професионалисти с дългогодишен опит. Предоставяме на своите клиенти
            всеобхватно правно обслужване в следните области на правото: вещно
            право, семейно и наследствено право, облигационно право, трудово
            право, търговско право, право на интелектуална собственост, реклама
            и медии, граждански и административен процес.
          </p>
