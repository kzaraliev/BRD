...
const navigation = [
  { name: "Начало", href: "#" },
  { name: "Екип", href: "#" },
  //{ name: 'Мисия и принципи', href: '#' },
  { name: "Сфери на дейност", href: "#" },
  { name: "Клиенти", href: "#" },
  { name: "Новини", href: "#" },
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <p className="mt-8 text-xl sm:text-2xl font-semibold italic text-gray-300 text-center relative before:content-['“'] before:text-4xl before:text-gold before:absolute before:-left-4 before:top-0 after:content-['”'] after:text-4xl after:text-gold after:absolute after:-right-4 after:top-0">
                В защита на вашите права и интереси с професионализъм и
                ангажираност.
              </p>
