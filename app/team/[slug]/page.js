    ...
    <>
      ...
      {/* <div className="bg-white py-24">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-20 px-6 lg:px-8 xl:grid-cols-5">
          <div className="flex flex-col justify-start items-center w-full xl:max-w-2xl xl:col-span-2 order-last xl:order-first">
            <Image
              width={250}
              height={375}
              alt={member.name}
          ...
          <div className="divide-y divide-gray-200 xl:col-span-3">
            <div
              className="text-gray-700 prose leading-relaxed"
              dangerouslySetInnerHTML={{
                __html: member.description,
      ...
      {/* <div className="mx-auto grid max-w-7xl gap-20 px-6 py-24 lg:px-8 xl:grid-cols-2">
        <div className="flex flex-col justify-start items-center w-full xl:max-w-2xl xl:col-span-1">
          <Image
            width={250}
            height={375}
            alt={member.name}
        ...
        <div className="divide-y divide-gray-200 xl:col-span-1">
          <div
            className="text-gray-700 prose leading-relaxed"
            dangerouslySetInnerHTML={{
              __html: member.description,
